...
const TESTIMONIALS = [
  ...
  },
  {
    id: "t3",
    quote:
      "From the initial menu consultation to the evening reception, Green Apple exceeded all our expectations. The biryani and live fish counters were the absolute highlight!",
